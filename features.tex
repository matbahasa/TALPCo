...
\begin{forest}
	[
		...
		[\textsf{lower}]
%		[\textsf{neutral}] % removed because ``neutral'' can be captured by the lack of a specific value
	]
\end{forest}
...
\begin{forest}
	[Position
		[\textsf{titled}
			[\textsf{head}
				[\textsf{territory}
					[\textsf{central}] %prime minister, president
					[\textsf{local}]
%					[\textsf{province}] %to/do/hu/ken (Japan), provinsi (Indonesia), negeri (Malaysia), changwat (Thailand)
%					[\textsf{city}] %shi/ku (Japan), kabupaten/kota (Indonesia), daerah (Malaysia), anphoe (Thailand)
%					[\textsf{town}] %cho (Japan), kecamatan (Indonesia), mukim (Malaysia), Tambon (Thailand)
%					[\textsf{village}] %son(Japan), kelurahan/desa (Indonesia), kampung (Malaysia), muban (Thailand)
%					[\textsf{other}]
				]
				[\textsf{organization}
					[\textsf{ministry}] %minister
					[\textsf{company}] %president
					[\textsf{education}] %headmaster, president, chancellor, rector
					[\textsf{other}] %head of department, committee
				]
			]
			[\textsf{conferred}] %Dato' etc. (Malaysia)
			[\textsf{other}] %Vice X, Deputy X, etc.
		]
		[\textsf{non\_titled}]
	]
\end{forest}
...
\begin{forest}
	[Relationship
		[\textsf{friend}]
		[\textsf{partner}
			[\textsf{married}] %spouse (cf. Family)
			[\textsf{unmarried}] %lover
		]
		[\textsf{mate} %teammate, classmate, schoolmate, colleague, etc.
			[\textsf{senior}]
			[\textsf{junior}]
		]
		[Obedience
			[\textsf{boss}] %master
			[\textsf{subordinate}] %servant
		]
	]
\end{forest}
...
\begin{forest}
	[Spiritual
		[\textsf{god}]
		[\textsf{leader}] %sultan, ulama
		[\textsf{clergy}
			[\textsf{Buddhism}] %monk
			[\textsf{Christianity}] %priest, pastor
			[\textsf{other}] %traditional healer, shaman
		]
		[\textsf{follower} %muslimin-muslimat (Malay)
			[\textsf{quasi\_clergy}] %maechi (Thai), thilashin (Burmese)
			[\textsf{other}]
		] 
	]
\end{forest}
...
%\begin{forest}
%	[Other
%		[\textsf{friend}] moved to Relationship
%	]
%\end{forest}
